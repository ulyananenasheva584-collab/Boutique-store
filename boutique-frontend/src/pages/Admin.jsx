...
import { Plus, Users, ShoppingBag, Star, TrendingUp, Package, MapPin, BarChart3, Trash2, Edit } from 'lucide-react'
...
// Новые данные для круговой диаграммы
const данныеКатегорий = {
    labels: ['Платья', 'Верхняя одежда', 'Брюки', 'Аксессуары', 'Обувь'],
    datasets: [
        {
...
export default function Admin() {
    ...
    // Динамические данные для графика категорий
    ...
    // ВРЕМЕННО: Разрешаем доступ всем залогиненным пользователям
    if (!user) {
        return (
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div key={index} className="border border-black p-6">
                    ...
                    <span className="text-sm text-green-600 font-medium">{стат.change}</span>
                    </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                <h3 className="text-lg font-normal mb-4 tracking-wide text-gray-900">Динамика продаж</h3>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                <h3 className="text-lg font-normal mt-1 tracking-wide text-gray-900">Продажи по регионам</h3>
                <div className="h-80 bg-white rounded-lg">
                <PieChart 
